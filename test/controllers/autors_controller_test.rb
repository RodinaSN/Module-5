...
class AutorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create autor" do
    assert_difference('Autor.count') do
      post autors_url, params: { autor: { name: @autor.name, surname: @autor.surname, year: @autor.year } }
    end
  ...
  test "should update autor" do
    patch autor_url(@autor), params: { autor: { name: @autor.name, surname: @autor.surname, year: @autor.year } }
